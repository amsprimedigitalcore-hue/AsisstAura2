    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center font-inter">
        <div className="text-center">
          ...
          <p className="text-[#2a3747] font-medium">Loading dashboard...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-6 py-3 text-left text-sm font-semibold text-[#2a3747] uppercase tracking-wider">Name</th>
                  <th className="px-6 py-3 text-left text-sm font-semibold text-[#2a3747] uppercase tracking-wider">Email</th>
                  <th className="px-6 py-3 text-left text-sm font-semibold text-[#2a3747] uppercase tracking-wider">Phone</th>
                  <th className="px-6 py-3 text-left text-sm font-semibold text-[#2a3747] uppercase tracking-wider">Service</th>
                  <th className="px-6 py-3 text-left text-sm font-semibold text-[#2a3747] uppercase tracking-wider">Date</th>
                  <th className="px-6 py-3 text-left text-sm font-semibold text-[#2a3747] uppercase tracking-wider">Actions</th>
                </tr>
              </thead>
          ...
          >
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-[#2a3747]">{selectedLead.name}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-[#2a3747]">{selectedLead.email}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-[#2a3747]">{selectedLead.phone}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-600">Service</p>
                    <p className="font-semibold text-[#2a3747]">{selectedLead.service}</p>
                  </div>
                </div>
              </div>
              ...
              {selectedLead.additional_message && (
                <div className="mb-6">
                  <p className="text-sm font-medium text-gray-600 mb-2">Additional Message</p>
